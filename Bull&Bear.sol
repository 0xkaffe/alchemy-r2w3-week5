...
contract BullBear is ERC721, ERC721Enumerable, ERC721URIStorage, KeeperCompatibleInterface, Ownable, VRFConsumerBaseV2  {
    ...
    bytes32 keyhash =  0x79d3d8832d904592c0bf9818b621522c988bb8b0c05cdc3b15aea1b6e8db0c15; // keyhash, see for Goerli https://docs.chain.link/vrf/v2/subscription/supported-networks#goerli-testnet
    ...
    */
    ...
    string[] bullUrisIpfs = [
        "https://ipfs.filebase.io/ipfs/QmS1v9jRYvgikKQD6RrssSKiBTBH3szDK6wzRWF4QBvunR?filename=gamer_bull.json",
        "https://ipfs.filebase.io/ipfs/QmRsTqwTXXkV8rFAT4XsNPDkdZs5WxUx9E5KwFaVfYWjMv?filename=party_bull.json",
        "https://ipfs.filebase.io/ipfs/QmZVfjuDiUfvxPM7qAvq8Umk3eHyVh7YTbFon973srwFMD?filename=simple_bull.json"
    ];
    string[] bearUrisIpfs = [
        "https://ipfs.filebase.io/ipfs/QmQMqVUHjCAxeFNE9eUxf89H1b7LpdzhvQZ8TXnj4FPuX1?filename=beanie_bear.json",
        "https://ipfs.filebase.io/ipfs/QmP2v34MVdoxLSFj1LbGW261fvLcoAsnJWHaBK238hWnHJ?filename=coolio_bear.json",
        "https://ipfs.filebase.io/ipfs/Qmc3ueexsATjqwpSVJNxmdf2hStWuhSByHtHK5fyJ3R2xb?filename=simple_bear.json"
    ];
    ...
    function requestRandomnessForNFTUris() internal {
        ...
        s_requestId = COORDINATOR.requestRandomWords(
            ...
            callbackGasLimit,
            1 // `numWords` : number of random values we want. Max number for Goerli is 500 (https://docs.chain.link/vrf/v2/subscription/supported-networks#goerli-testnet)
        );
